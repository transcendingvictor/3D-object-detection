...
useremail = "transcendingvictor@gmail.com"
password = "MQriR@u8eJdA*V6"


current_directory = os.getcwd()

output_dir = os.path.join(current_directory, "nuscenes_data")
...
download_files = {
    ...
    "v1.0-mini.tgz": "md5checksum_of_the_mini_file"
